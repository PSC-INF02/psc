...
class Entity:
	...
	* a list of references where the entity is referred to in the text, under the norm (paragraphNumber, wordNumber)
	'''
	...
	def add_reference(self, reference):
		...
		@param reference a reference tuple : (paragraphNumber, wordNumber)
		'''
